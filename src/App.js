...
class App extends Component {
  constructor(props) {
    super(props);
    // Set the default state of our app
    this.state = { addingTodo: false, pendingTodo: "", todos: [] };
    // event handlers to share this context
    this.addTodo = this.addTodo.bind(this);
    this.completeTodo = this.completeTodo.bind(this);
    // listen for live changes to our todos collection in Firebase
  ...
  render() {
    return (
      <Layout className="App">
        ...
        <Footer className="App-footer">&copy; Created  by S.M.Farrukh Azeem</Footer>
      </Layout>
    );
  }
}
